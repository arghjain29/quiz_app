...
export default function Home() {
  ...
  const handleAnswer = (isCorrect, selectedOptionIndex) => {
    if (isCorrect) {
      setScore(score + 4)
  ...
  const resetQuiz = () => {
    ...
    setScore(0)
    setUserAnswers([])
    setAnswerStatus({ correct: 0, incorrect: 0 })
  }

  return (
    <main className="flex flex-col items-center justify-start bg-gradient-to-r from-blue-900 to-purple-800 min-h-screen py-8 px-4">
      ...
      <div className="w-full max-w-2xl bg-white shadow-2xl rounded-lg p-6 mb-8">
